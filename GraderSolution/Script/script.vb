...
Public Class Script
    ...
    Private Sub runCommand(ByRef args As String())
        ...
        Select Case args(0).ToLower
            ...
            Case "find"
                scriptCommander.find(args(1), args(2))
                loadedProperty = args(2)

            Case "form"
                scriptCommander.loadForm(args(1))
                currentForm = args(1)
            ...
            Case Else
                If loadedProperty.Length > 0 Then
                    ...
                    End If
                Else
                    Console.WriteLine("No Form component Loaded to Check")
